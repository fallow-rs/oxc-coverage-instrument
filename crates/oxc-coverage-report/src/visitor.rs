...
//!
//! Every method has a default no-op implementation so reporters only override
//! the callbacks they care about, and so adding a new callback in a future
//! release does not break downstream impls.
