...
//! Istanbul-compatible coverage data (a [`CoverageMap`] parsed by
...
//!
//! Reporters (text, text-summary, json-summary, lcov, cobertura, and html
//! behind the `html` feature) live in the sibling `oxc_coverage_reports` crate.
...
//! assert_eq!(visitor.folders, 1);
//! ```
//!
//! [upstream]: https://github.com/istanbuljs/istanbuljs/tree/istanbul-lib-report-v3.0.1/packages/istanbul-lib-report
